...
class EncoderConv(nn.Module):
    def __init__(self, latents = 64, hw = 16):
        ...
        self.fc_mu = nn.Linear(in_features=size[4]*hw[0]*hw[1], out_features=self.latents)
        self.fc_logvar = nn.Linear(in_features=size[4]*hw[0]*hw[1], out_features=self.latents)
